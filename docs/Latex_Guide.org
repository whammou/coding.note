...
#+FILETAGS: :topCoding:typDoc:subProject:LATEX:GUIDE:
...
* DONE [#A] Setup editor for latex :subNvim:
...
* TODO [#A] Files conversion :subPandoc:GEMINI:
...
** Pandoc conversion :subPandoc:
:PROPERTIES:
:ID: 1abf84ee-8c47-4c60-bdca-99627c2a7908
:END:
